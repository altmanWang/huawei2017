...
class Chromosome {
    ...
    public Chromosome(int size, double[] performance, LinkedList<Vertex<Integer>> clients, float rate) {
...
class Optimization {
    ...
    public void test() {
        ...
        System.out.println(certain_servers.size());
    ...
    public void setup() {
        ...
        verify(sample_individual);
        System.out.println(certain_servers);
    }
    ...
    */
    ...
    public void localSearch() {
        ...
        for(int i =0; i < rand; i++){
            idx = certain_servers.get(random.nextInt(certain_servers.size()));
            tmp.gene[idx] = 0.5 > Math.random();
        }
